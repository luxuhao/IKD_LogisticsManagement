...
package com.example.sendapp.ui.db;
...
@TargetApi(Build.VERSION_CODES.GINGERBREAD) @SuppressLint("NewApi") public class CookieDB {
	Context mContext;
	...
	public CookieDB(Context appContext) {
		mContext = appContext;
